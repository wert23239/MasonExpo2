...
HTML;
    ...
    public function presentDisplay()
    {
        ...
        for ($i = 0; $i<$Count;$i++)
        {
            ...
            $html.=<<<HTML
            $html.="<div class='col-xs-3 col-md-3'><a href='http://www.linkedin.com/in/alexlambert52' class='thumbnail' target='_blank'><img class='img-responsive box'  src='images/in.png'/></a></div>";
HTML;
            if($i%4==0){
                $html.=<<<HTML
                </div>
